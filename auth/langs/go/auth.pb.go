...
func (x *ResendVerificationCodeResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	...
	"\x1eResendVerificationCodeResponse\x12\x16\n" +
...
var file_auth_proto_depIdxs = []int32{
	...
	12, // 4: auth.AuthService.RefreshToken:input_type -> auth.RefreshTokenRequest
	...
	14, // 7: auth.AuthService.ValidateToken:input_type -> auth.ValidateTokenRequest
	...
	13, // 12: auth.AuthService.RefreshToken:output_type -> auth.RefreshTokenResponse
	...
	15, // 15: auth.AuthService.ValidateToken:output_type -> auth.ValidateTokenResponse
