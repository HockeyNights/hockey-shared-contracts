...
const (
	...
	AuthService_VerifyLoginCode_FullMethodName      = "/auth.v1.AuthService/VerifyLoginCode"
	AuthService_ResendCode_FullMethodName           = "/auth.v1.AuthService/ResendCode"
...
//
// AuthService отвечает за регистрацию, вход и жизненный цикл сессий
type AuthServiceClient interface {
	...
	// Восстановление пароля: код на почту, затем смена по коду.
	//
	// Разделено на два вызова, а не «пришлите ссылку»: код короткий, его
	// можно ввести на другом устройстве, и он не утекает в историю браузера
	// и в реферер, как одноразовая ссылка.
