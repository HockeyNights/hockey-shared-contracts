...
type CreateTemplateRequest struct {
	...
	TextBodyTemplate string                 `protobuf:"bytes,4,opt,name=text_body_template,json=textBodyTemplate,proto3" json:"text_body_template,omitempty"`
	HtmlBodyTemplate string                 `protobuf:"bytes,5,opt,name=html_body_template,json=htmlBodyTemplate,proto3" json:"html_body_template,omitempty"`
...
const file_mail_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"mail.proto\x12\x04mail\"\x8a\x01\n" +
	...
	"\thtml_body\x18\x04 \x01(\tR\bhtmlBody\x12\x12\n" +
	"\x04from\x18\x05 \x01(\tR\x04from\"F\n" +
	"\x11SendEmailResponse\x12\x19\n" +
	"\bemail_id\x18\x01 \x01(\tR\aemailId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"\xee\x01\n" +
	"\x18SendTemplateEmailRequest\x12\x0e\n" +
	"\x02to\x18\x01 \x03(\tR\x02to\x12#\n" +
	"\rtemplate_code\x18\x02 \x01(\tR\ftemplateCode\x12K\n" +
	"\tvariables\x18\x03 \x03(\v2-.mail.SendTemplateEmailRequest.VariablesEntryR\tvariables\x12\x12\n" +
	...
	"\x05email\x18\x01 \x01(\v2\x12.mail.EmailMessageR\x05email\"\xa4\x04\n" +
	...
	"\rtemplate_code\x18\x0f \x01(\tR\ftemplateCode\x12?\n" +
	"\tvariables\x18\x10 \x03(\v2!.mail.EmailMessage.VariablesEntryR\tvariables\x1a<\n" +
	"\x0eVariablesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x12text_body_template\x18\x04 \x01(\tR\x10textBodyTemplate\x12,\n" +
	"\x12html_body_template\x18\x05 \x01(\tR\x10htmlBodyTemplate\x12\x12\n" +
	"\x04from\x18\x06 \x01(\tR\x04from\"I\n" +
	"\x16CreateTemplateResponse\x12/\n" +
	"\btemplate\x18\x01 \x01(\v2\x13.mail.EmailTemplateR\btemplate\"(\n" +
	"\x12GetTemplateRequest\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\"F\n" +
	"\x13GetTemplateResponse\x12/\n" +
	"\btemplate\x18\x01 \x01(\v2\x13.mail.EmailTemplateR\btemplate\"\xa0\x02\n" +
	...
	"\n" +
	"updated_at\x18\t \x01(\tR\tupdatedAt2\xe5\x02\n" +
	"\vMailService\x12<\n" +
	"\tSendEmail\x12\x16.mail.SendEmailRequest\x1a\x17.mail.SendEmailResponse\x12L\n" +
	"\x11SendTemplateEmail\x12\x1e.mail.SendTemplateEmailRequest\x1a\x17.mail.SendEmailResponse\x129\n" +
	"\bGetEmail\x12\x15.mail.GetEmailRequest\x1a\x16.mail.GetEmailResponse\x12K\n" +
	"\x0eCreateTemplate\x12\x1b.mail.CreateTemplateRequest\x1a\x1c.mail.CreateTemplateResponse\x12B\n" +
	"\vGetTemplate\x12\x18.mail.GetTemplateRequest\x1a\x19.mail.GetTemplateResponseB6Z4github.com/HockeyNights/contracts/mail/langs/go;mailb\x06proto3"
...
var file_mail_proto_goTypes = []any{
	...
	(*SendTemplateEmailRequest)(nil), // 2: mail.SendTemplateEmailRequest
	(*GetEmailRequest)(nil),          // 3: mail.GetEmailRequest
	(*GetEmailResponse)(nil),         // 4: mail.GetEmailResponse
	(*EmailMessage)(nil),             // 5: mail.EmailMessage
	(*CreateTemplateRequest)(nil),    // 6: mail.CreateTemplateRequest
	(*CreateTemplateResponse)(nil),   // 7: mail.CreateTemplateResponse
	(*GetTemplateRequest)(nil),       // 8: mail.GetTemplateRequest
	(*GetTemplateResponse)(nil),      // 9: mail.GetTemplateResponse
	(*EmailTemplate)(nil),            // 10: mail.EmailTemplate
	nil,                              // 11: mail.SendTemplateEmailRequest.VariablesEntry
	nil,                              // 12: mail.EmailMessage.VariablesEntry
}
var file_mail_proto_depIdxs = []int32{
	11, // 0: mail.SendTemplateEmailRequest.variables:type_name -> mail.SendTemplateEmailRequest.VariablesEntry
	5,  // 1: mail.GetEmailResponse.email:type_name -> mail.EmailMessage
	12, // 2: mail.EmailMessage.variables:type_name -> mail.EmailMessage.VariablesEntry
	10, // 3: mail.CreateTemplateResponse.template:type_name -> mail.EmailTemplate
	10, // 4: mail.GetTemplateResponse.template:type_name -> mail.EmailTemplate
	0,  // 5: mail.MailService.SendEmail:input_type -> mail.SendEmailRequest
	2,  // 6: mail.MailService.SendTemplateEmail:input_type -> mail.SendTemplateEmailRequest
	3,  // 7: mail.MailService.GetEmail:input_type -> mail.GetEmailRequest
	6,  // 8: mail.MailService.CreateTemplate:input_type -> mail.CreateTemplateRequest
	8,  // 9: mail.MailService.GetTemplate:input_type -> mail.GetTemplateRequest
	1,  // 10: mail.MailService.SendEmail:output_type -> mail.SendEmailResponse
	1,  // 11: mail.MailService.SendTemplateEmail:output_type -> mail.SendEmailResponse
	4,  // 12: mail.MailService.GetEmail:output_type -> mail.GetEmailResponse
	7,  // 13: mail.MailService.CreateTemplate:output_type -> mail.CreateTemplateResponse
	9,  // 14: mail.MailService.GetTemplate:output_type -> mail.GetTemplateResponse
