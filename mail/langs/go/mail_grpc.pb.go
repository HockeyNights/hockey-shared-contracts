...
const (
	...
	MailService_SendTemplateEmail_FullMethodName = "/mail.MailService/SendTemplateEmail"
	MailService_GetEmail_FullMethodName          = "/mail.MailService/GetEmail"
	MailService_CreateTemplate_FullMethodName    = "/mail.MailService/CreateTemplate"
	MailService_GetTemplate_FullMethodName       = "/mail.MailService/GetTemplate"
)
...
func (c *mailServiceClient) GetEmail(ctx context.Context, in *GetEmailRequest, opts ...grpc.CallOption) (*GetEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMailServiceServer) GetEmail(context.Context, *GetEmailRequest) (*GetEmailResponse, error) {
